...
namespace EmployeeImputedWinForms
{
    ...
    public class StartupInfoForm : Form
    {
        public StartupInfoForm()
        {
            ...
            label1.Text = """
• Calculates the portion of GTL coverage that may be subject to federal income tax.
